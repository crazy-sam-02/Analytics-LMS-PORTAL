  ...
  return (
    <section className="relative grid min-h-screen place-items-center overflow-hidden bg-[#f5f9ff] p-4 text-slate-950 sm:p-6 lg:p-8">
      ...
      <Card className="relative grid w-full max-w-7xl overflow-hidden rounded-[24px] border-white/80 bg-white shadow-[0_32px_90px_-36px_rgba(15,35,71,0.55)] lg:min-h-[760px] lg:grid-cols-[1.12fr_0.88fr]">
        <div className="relative hidden min-h-[520px] overflow-hidden bg-[#0837df] p-8 text-white lg:block lg:min-h-full lg:p-14">
          ...
          <div className="absolute left-[-18%] top-[22%] h-64 w-[138%] rotate-[-31deg] rounded-[42px] border border-cyan-300/20 bg-white/[0.03] shadow-[0_0_50px_rgba(34,211,238,0.16)]" />
          <div className="absolute left-[-12%] bottom-[11%] h-48 w-[130%] rotate-[-27deg] rounded-[36px] border border-blue-100/12 bg-blue-950/10" />
          <div className="absolute bottom-30 left-[-10%] h-px w-[120%] rotate-[-28deg] bg-linear-to-r from-transparent via-cyan-300/70 to-transparent shadow-[0_0_22px_rgba(34,211,238,0.8)]" />
          <div className="absolute bottom-16 left-[6%] h-px w-[110%] rotate-[-28deg] bg-linear-to-r from-transparent via-violet-300/65 to-transparent shadow-[0_0_20px_rgba(167,139,250,0.7)]" />
          <div className="absolute top-28 left-[16%] h-px w-[92%] rotate-[-31deg] bg-linear-to-r from-transparent via-blue-200/40 to-transparent" />
          <img
            src="/favicon.svg"
            alt=""
            aria-hidden="true"
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            ...
            <div className="flex w-full max-w-sm items-center gap-3 rounded-2xl border border-white/25 bg-white/10 px-5 py-4 text-sm font-semibold text-white shadow-[0_20px_55px_-24px_rgba(0,0,0,0.7)] backdrop-blur-xl">
              <span className="grid size-9 place-items-center rounded-full border border-white/35 bg-white/15 shadow-[0_0_26px_rgba(125,211,252,0.45)]">
                <Globe2 className="size-5" />
              </span>
              <span>Global visibility across all colleges</span>
            </div>
          </div>
        </div>
            ...
            <form onSubmit={onSubmit} className="mt-10 space-y-6">
              ...
              <div>
                <div className="mb-2.5 flex items-center justify-between text-xs font-bold tracking-wide text-slate-600 uppercase">
                  <span>Password</span>
                  <Link to="/super-admin/forgot-password" className="text-xs font-bold tracking-normal text-blue-600 normal-case hover:text-blue-700">
                    Forgot Password?
                  </Link>
                </div>
                <div className="flex h-14 items-center gap-3 rounded-xl border border-slate-200 bg-white px-4 shadow-[0_1px_2px_rgba(15,23,42,0.04),inset_0_1px_0_rgba(255,255,255,0.9)] transition focus-within:border-blue-500 focus-within:shadow-[0_0_0_4px_rgba(37,99,235,0.10)]">
